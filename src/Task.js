        ...
        return (
            <li className="task">
                {/* <input type="checkbox" className="done"></input> */}
                {
                    this.props.done 
                    ?
                    <img src={checkboxEnabled} className="done" alt="" onClick={() => this.props.toggleDone(this.props._id)}></img>
                    :
                    <img src={checkbox} className="done" alt="" onClick={() => this.props.toggleDone(this.props._id)}></img>
                }
